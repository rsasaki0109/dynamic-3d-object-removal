  ...
  <body>
    <div class="shell">
      ...
      <section class="compare-card">
        ...
        <div class="note-box">
          drag: orbit / wheel: zoom / right drag: pan. the page opens at the final accumulation because that is where the map contamination difference is clearest. use <code>Replay build-up</code> to watch how the raw-only footprint grows over time. in box mode, removed counts mean all supplied annotation crops (including parked objects), not moving-track GT or detector-free accuracy. when detections are absent, the checked-in page bootstraps transient boxes and uses them for a sampled box-removal preview.
        </div>
      </section>
    </div>
